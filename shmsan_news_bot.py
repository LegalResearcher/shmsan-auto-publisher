...
- الهيكل والتنسيق: أعد كتابة المتن بحيث تبدأ كل جملة جديدة في سطر/فقرة مستقلة بعد النقطة أو علامة الاستفهام أو التعجب. لا تكتب الرموز الحرفية `\\n` أو `\\n\\n` داخل المحتوى، مع الالتزام بقاعدة الهرم المقلوب (المقدمة الأهم، ثم التفاصيل الكاملة، ثم الخلفية).
...
6. التنسيق وإخفاء بصمة الآلة: اكتب كل جملة في سطر/فقرة مستقلة بعد النقطة أو علامة الاستفهام أو التعجب. لا تكتب الرموز الحرفية `\\n` أو `\\n\\n` داخل المحتوى، واجعل الخبر ينتهي طبيعيًا بنهاية وقائعه دون أي خواتيم معلبة.
...
- اكتب content بحيث تبدأ كل جملة جديدة في فقرة مستقلة بعد النقطة أو علامة الاستفهام أو التعجب. لا تكتب الرموز الحرفية `\\n` أو `\\n\\n` داخل المحتوى.
