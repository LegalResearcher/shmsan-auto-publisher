...
6. التنسيق وإخفاء بصمة الآلة: اكتب المادة على شكل فقرات منفصلة تفصل بين كل فقرة والتي تليها بعلامتي السطر الجديد (\\n\\n)، واجعل الخبر ينتهي طبيعياً بنهاية وقائعه دون أي خواتيم معلبة.
