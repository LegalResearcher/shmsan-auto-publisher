...
- طَبّق فوراً "شرط المعالجة الاحترافية لأخبار صنعاء/الحوثيين" الوارد في البرومبت الأساسي للوقائع الميدانية والعسكرية.
- يُحظر نشر أي تقرير أو خبر يتضمن مجرد هجوم سياسي أو كلامي أو تصريحات استنكار ضد الحوثيين/إيران دون وجود مواجهة عسكرية على الأرض.
- جرد النص كلياً من أي لغة تعبوية أو عقائدية أو شتائم من أي طرف.
- أسنِد الرواية الميدانية بمهنية (مثل: "أعلنت قوات صنعاء"، "أفادت مصادر ميدانية").
- لا تختصر الوقائع الميدانية ولا تحذف الأرقام، وركز على الأثر الميداني والمواطن.
- احظر نقل التعيينات أو القرارات الإدارية والبروتوكولية لسلطات صنعاء.
"""
    else:
        dynamic_instruction = """
