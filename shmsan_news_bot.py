...
- الإشارة للطرف المقابل بأسمائه التحريرية المعتمدة ("قوات المجلس الانتقالي" أو "القوات المدعومة سعودياً").
...
• المسموح والمرغوب: تسليط الضوء على معاناة المواطن في المحافظات الجنوبية، نقد الفساد، نقد التبعية للتحالف السعودي، والتغطية الميدانية للأنشطة والوقائع بأسلوب صحفي رصين.
• المحظور تماماً: يُحظر نشر أي مادة تتضمن تحريضاً طائفياً أو مناطقياً، أو تروج لمشروعية التواجد الأجنبي/السعودي،الاماراتي، أو تهاجم موقف صنعاء السيادي والعسكري.
...
• حظر الخواتيم الروتينيّة والقوالب الجاهزة والزيادات الخارجية (صارم جداً):
  - يُمنع منعاً باتاً ختم الخبر بجمل تعميمية أو عبارات إنشائية مكررة (مثل: "يبقى السؤال.."، "في ظل معاناة المواطنين.."، "وسط تجاهل السلطات..").
