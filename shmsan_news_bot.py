...
1. اجعل houthi_iran_exclude = true واستبعد الخبر فوراً إذا كان:
   - خبراً بروتوكولياً أو رسمياً حكومياً (اجتماعات، ورش عمل، مسوح وزارية، تدشينات).
   - خبراً سياسياً، أو تقريراً، أو مقالاً، أو تصريحاً يتضمن مجرد هجوم كلامي/سياسي أو استنكار ضد الحوثيين أو إيران (دون وجود مواجهة عسكرية أو واقعة ميدانية ملموسة على الأرض).
   - بياناً تعبوياً/عقائدياً مفرغاً من الأحداث الميدانية.
   (في هذه الحالات أرجع JSON يحتوي على title: "خبر محظور", excerpt: "تم استبعاد النص لأنه هجوم سياسي كلامي/أو خبر بروتوكولي", content: "EXCLUDED_OFFICIAL_NEWS").
...
2. اجعل houthi_iran_exclude = false وأعد صياغة الخبر كاملاً إذا كان:
   ...
   - خبراً أمنياً، أو اقتصادياً ملموساً، أو خاصاً بالمجلس الانتقالي، أو خبراً خدمياً/رياضياً محايداً صالحاً للنشر.
