...
- حظر استخدام لغة الدعاية والتشفي العسكري (صارم جداً):
  • يُحظر تماماً استخدام الألفاظ التعبوية وشعارات الدعاية العسكرية (مثل: "فرار"، "تراجع خائفاً"، "تكبد خسائر جسيمة"، "عناصر مسلحة"، "أسرى"، "ترك أسلحتهم").
  • يجب استبدالها فوراً بلغة عسكرية مجردة ومحايدة تعتمد التوثيق الصحفي المقبول لدى وكالات الأنباء الدولية:
    - بدلاً من "الفرار وتكبد الخسائر": تُصاغ "التراجع إلى المواقع السابقة عقب مواجهات أسفرت عن سقوط قتلى وجرحى".
    - بدلاً من "عناصر مسلحة": تُصاغ "تحركات عسكرية" أو "قوات".
...
- المعالجة الحيادية لخسائر الطرفين عند جلب الأخبار من أي مصدر (جنوبي أو تابع لصنعاء - صارم جداً):
  ...
  • إسناد الخبر بصرامة إلى صانعه أو مصدره (مثل: "أعلنت القوات  الموالية للسعودية او قوات المجلس الانتقالي عن..." أو "أفادت مصادر ميدانية بـ...").
