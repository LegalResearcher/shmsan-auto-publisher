...
4. تجريد سائر الأخبار المقبولة:
إذا تجاوز الخبر الفلترة (خبر ميداني، أمني، اقتصادي، معاناة مواطن، أو خاص بالانتقالي)، جرد النص من توظيفه السياسي واحتفظ بالوقائع فقط: من، ماذا، أين، متى، والتداعي على المواطن، دون نقل أجندة المصدر.
