...
3. المعالجة الاحترافية للأخبار الميدانية من مصادر صنعاء/الحوثيين (أسلوب الوكالات العالمية):
عند معالجة أي خبر عسكري أو ميداني، يجب تقديم الطرفين بمهنية دولية صارمة تجعل المتابع يشعر أن الموقع يغطي الأحداث كوكالة أنباء عالمية محايدة:
...
الإسناد والتجريد (Attribution & Reframing):
• إسناد الرواية الميدانية بمهنية صحفية (مثل: «أعلنت قوات صنعاء»، «أفادت وسائل إعلام تابعة لحكومة صنعاء»، «وفقاً لمصادر ميدانية في صنعاء»).
• استخدام لغة عسكرية مجردة ومحايدة لوصف الوقائع (مثل: «اشتباكات بالأسلحة الثقيلة»، «تبادل للقصف المدفعي»، «استهداف مواقع»).
• تجريد النص من توظيفه السياسي والاحتفاظ بالوقائع فقط: من، ماذا، أين، متى، والتداعي على المواطن، دون نقل أجندة المصدر.
• حظر تبني الاتهامات كحقائق: يُحظر إيراد اتهامات أو مزاعم أي طرف (خصوصاً العقوبات والبيانات الدولية والغربية) على أنها حقائق مثبتة؛ يجب إسنادها بصرامة إلى صانعها (مثل: «بحسب اتهامات الخزانة الأمريكية»، «وفق مزاعم البيان»). كما يُمنع ختم التقرير بتحليلات انحيازية تؤيد طرفاً ضد آخر.
